<template>
  <p>
    <RouterLink :to="`/students/${route.params.id}`" class="link"
      >&lt; Back to student</RouterLink
    >
  </p>
  <div>
    <h1 class="text-4xl font-medium">Edit Student</h1>
      ...
      <div class="space-y-4">
        ...
        <div class="grid grid-cols-2 gap-4">
          ...
          <div class="fieldset flex flex-col gap-2">
            ...
            <input
              type="text"
              placeholder="Enter student short code"
              required
              v-model="form.email"
            />
          </div>
...
const { editStudent, getStudent } = useStudentsStore();
...
async function submitForm() {
  if (
    ...
    await editStudent(form.value).then(() => {
